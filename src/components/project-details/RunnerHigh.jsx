    ...
    <div className="project-detail-container">
      ...
      <section className="detail-section">
        ...
        <div className="contribution-item">
          ...
          <p>
            기존의 러닝 크루 문화는 카카오톡 오픈채팅이나 네이버 밴드 등을 통해 <strong>정량적인 기준 없이 인원을 모집</strong>하는 방식이 주를 이뤘습니다.
        ...
        <div className="contribution-item">
          ...
          <ul className="detail-list bullet">
            <li><strong>스탭업 (Step-Up / 2:2 매칭):</strong> 상위 레벨 멘토와 멘티를 1:1 비율로 매칭하여, 실질적인 <strong>기량 향상</strong>에 중점을 둔 고강도 성장형 구성입니다.</li>
            <li><strong>러닝 커넥트 (Running Connect / 동급 4인):</strong> 유사한 퍼포먼스 데이터를 가진 러너 4명을 매칭하여, 서로 건전한 경쟁(외부 자극)을 유도하고 러닝의 즐거움을 극대화하는 구성입니다.</li>
            <li><strong>러닝 메이트 (Running Mate / 1:3 매칭):</strong> 리더 1명과 팔로워 3명을 매칭하여, 멘토의 부담은 줄이되 그룹 전체의 <strong>안정적인 완주와 동기부여</strong>를 균형 있게 달성하는 구성입니다.</li>
          </ul>
        </div>
        ...
        <div className="contribution-item">
          ...
          <p>
            각 그룹의 특성에 맞는 '데이터 기반 맞춤형 미션'을 자동 생성하여 제공함으로써, 사용자는 대규모 크루에 가입하지 않고도 체계적인 훈련이 가능합니다.
            결과적으로 <strong>소규모 그룹 중심의 건전한 러닝 문화</strong>를 정착시켜 지역 주민과의 갈등을 해소하고, 사용자에게는 최적의 러닝 경험을 제공합니다.
          </p>
        </div>
      </section>
      ...
      <section className="detail-section">
        ...
        <div className="contribution-item">
          ...
          <ul className="detail-list bullet">
            <li><strong>데이터 기반 비즈니스 모델 수립:</strong> 심박수, 케이던스 기반 매칭 아이디어 제안 및 3가지 알고리즘 설계.</li>
        ...
        <div className="contribution-item">
          ...
          <ul className="detail-list bullet">
            <li><strong>RDBMS 스키마 설계:</strong> MariaDB와 Nest.js(TypeORM) 환경에서 User, Crew, Post 등 핵심 엔티티 정규화 설계.</li>
            <li><strong>개발 환경 표준화:</strong> 초기 API 아키텍처 및 베이스 코드를 구축하여 팀 협업 효율성 강화.</li>
          </ul>
        </div>
        ...
        <div className="contribution-item">
          ...
          <ul className="detail-list bullet">
            <li><strong>WatchOS 수집 인터페이스:</strong> SwiftUI를 활용한 Apple Watch 앱 프로토타입 및 헬스 데이터 수집 UX 구현.</li>
